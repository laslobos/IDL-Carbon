...
const TagBase = /*#__PURE__*/React.forwardRef(({
  ...
  if (filter) {
    ...
    return /*#__PURE__*/React.createElement(ComponentTag, _rollupPluginBabelHelpers.extends({
      className: tagClasses,
      id: tagId
    }, other), CustomIconElement && size !== 'sm' ? /*#__PURE__*/React.createElement("div", {
      className: `${prefix}--tag__custom-icon`
    }, /*#__PURE__*/React.createElement(CustomIconElement, null)) : '', /*#__PURE__*/React.createElement(Text.Text, {
  ...
  return /*#__PURE__*/React.createElement(ComponentTag, _rollupPluginBabelHelpers.extends({
    ...
    className: `${prefix}--tag__custom-icon`
  }, /*#__PURE__*/React.createElement(CustomIconElement, null)) : '', isEllipsisApplied && !isInteractiveTag ? /*#__PURE__*/React.createElement(DefinitionTooltip.DefinitionTooltip, {
    openOnHover: false,
  ...
  }, children !== null && children !== undefined ? children : typeText)) : /*#__PURE__*/React.createElement(Text.Text, {
    title: children !== null && children !== undefined && typeof children === 'string' ? children : typeText,
    className: labelClasses
...
Tag.propTypes = {
   ...
   */
  filter: deprecate.deprecate(PropTypes.bool, 'The `filter` prop has been deprecated and will be removed in the next major version. Use DismissibleTag instead.'),
  /**
   ...
   */
  onClose: deprecate.deprecate(PropTypes.func, 'The `onClose` prop has been deprecated and will be removed in the next major version. Use DismissibleTag instead.'),
  /**
   ...
   */
  title: deprecate.deprecate(PropTypes.string, 'The `title` prop has been deprecated and will be removed in the next major version. Use DismissibleTag instead.'),
  /**
