...
const TextArea = frFn((props, forwardRef) => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: `${prefix}--text-area__invalid-icon`
  }), warn && !invalid && !isFluid && /*#__PURE__*/React.createElement(iconsReact.WarningAltFilled, {
    className: `${prefix}--text-area__invalid-icon ${prefix}--text-area__invalid-icon--warning`
...
TextArea.propTypes = {
   ...
   */
  light: deprecate.deprecate(PropTypes.bool, 'The `light` prop for `TextArea` has ' + 'been deprecated in favor of the new `Layer` component. It will be removed in the next major release.'),
  /**
   ...
   */
  slug: deprecate.deprecate(PropTypes.node, 'The `slug` prop for `TextArea` has ' + 'been deprecated in favor of the new `decorator` prop. It will be removed in the next major release.'),
  /**
