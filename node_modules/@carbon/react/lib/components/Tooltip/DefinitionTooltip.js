...
const DefinitionTooltip = ({
  ...
  return /*#__PURE__*/React.createElement(index.Popover, {
    ...
    open: isOpen
  }, /*#__PURE__*/React.createElement("button", _rollupPluginBabelHelpers.extends({}, rest, {
    ...
    onKeyDown: onKeyDown,
    type: "button"
  }), children), /*#__PURE__*/React.createElement(index.PopoverContent, {
...
DefinitionTooltip.propTypes = {
   ...
   */
  tooltipText: deprecate.deprecate(PropTypes.node, 'The tooltipText prop has been deprecated. Please use the `definition` prop instead.'),
  /**
